...
function Showcase() {
  return <section id="work" className="overflow-hidden bg-paper px-5 py-28 text-ink md:px-10 md:py-44"><div className="mx-auto max-w-[1600px]"><Reveal><div className="eyebrow text-earth"><span/>Selected craftsmanship</div><h2 className="section-title mt-6 max-w-5xl">DETAILS DEFINE<br/><em>THE DIFFERENCE.</em></h2></Reveal><div className="mt-16 grid gap-5 md:grid-cols-12 md:grid-rows-[17rem_29rem]"><motion.figure initial={{ clipPath:"inset(0 0 100% 0)" }} whileInView={{ clipPath:"inset(0 0 0% 0)" }} viewport={{ once:true, amount:.2 }} transition={{ duration:1.2, ease }} className="group relative overflow-hidden md:col-span-8 md:row-span-2" data-cursor="VIEW"><img src={craftImage} alt="Roofing professional carefully installing charcoal shingles" width={1440} height={1808} loading="lazy" className="h-full w-full object-cover transition-transform duration-[1400ms] group-hover:scale-[1.035]"/><figcaption className="image-caption"><span>Residential installation</span><span>Clarksville, TN</span></figcaption></motion.figure><motion.figure initial={{ clipPath:"inset(100% 0 0 0)" }} whileInView={{ clipPath:"inset(0 0 0 0)" }} viewport={{ once:true, amount:.2 }} transition={{ duration:1.2, delay:.1, ease }} className="group relative min-h-72 overflow-hidden md:col-span-4" data-cursor="VIEW"><img src={detailImage} alt="Close detail of ridge cap and precision roof flashing" width={1408} height={1056} loading="lazy" className="h-full w-full object-cover transition-transform duration-[1400ms] group-hover:scale-[1.04]"/><figcaption className="image-caption"><span>Material precision</span><span>Detail 01</span></figcaption></motion.figure><div className="flex flex-col justify-between border-t border-line-light pt-6 md:col-span-4"><p className="font-display text-3xl leading-tight md:text-4xl">Every line considered.<br/>Every layer built to endure.</p><p className="mt-10 max-w-xs text-sm leading-6 text-copy-light">The best roofing work is measured in the details you see—and the protection you never have to think about.</p></div></div><motion.figure initial={{ clipPath:"inset(0 100% 0 0)" }} whileInView={{ clipPath:"inset(0 0 0 0)" }} viewport={{ once:true, amount:.2 }} transition={{ duration:1.3, ease }} className="group relative mt-5 aspect-[16/8] overflow-hidden" data-cursor="VIEW"><img src={aerialImage} alt="Aerial view of a completed charcoal residential roof" width={1600} height={1200} loading="lazy" className="h-full w-full object-cover transition-transform duration-[1600ms] group-hover:scale-[1.025]"/><figcaption className="image-caption"><span>Complete roofing system</span><span>Aerial study</span></figcaption></motion.figure></div></section>;
}
